...
// roli (custom0 space)
#define MATCH_ROLI 0x600b
#define MASK_ROLI  0xfe00707f
// speck (custom0 space)
#define MATCH_ROR8ADD 0x8000700b
#define MASK_ROR8ADD  0xfe00707f

// chacha (custom1 space)
#define MATCH_XORROL16 0x8000702b
#define MASK_XORROL16 0xfe00707f
#define MATCH_XORROL12 0xc000702b
#define MASK_XORROL12 0xfe00707f
#define MATCH_XORROL8 0xe000702b
#define MASK_XORROL8 0xfe00707f
#define MATCH_XORROL7 0xf000702b
#define MASK_XORROL7 0xfe00707f

// rol.xor (custom2 space)
#define MATCH_ROL16XOR 0x8000705b
#define MASK_ROL16XOR 0xfe00707f
#define MATCH_ROL13XOR 0xc000705b
#define MASK_ROL13XOR 0xfe00707f
#define MATCH_ROL12XOR 0xe000705b
#define MASK_ROL12XOR 0xfe00707f
#define MATCH_ROL8XOR 0xf000705b
#define MASK_ROL8XOR 0xfe00707f
#define MATCH_ROL7XOR 0xf800705b
#define MASK_ROL7XOR 0xfe00707f
#define MATCH_ROL5XOR 0xfc00705b
#define MASK_ROL5XOR 0xfe00707f
#define MATCH_ROL3XOR 0xfe00705b
#define MASK_ROL3XOR 0xfe00707f

// chaskey (custom3 space)
#define MATCH_CHASKEY5 0x707b
#define MASK_CHASKEY5  0xfe00707f
#define MATCH_CHASKEY8 0x8000707b
#define MASK_CHASKEY8  0xfe00707f
#define MATCH_CHASKEY7 0xc000707b
#define MASK_CHASKEY7 0xfe00707f
#define MATCH_CHASKEY13 0xe000707b
#define MASK_CHASKEY13 0xfe00707f
#define MATCH_ADDROL16 0x80001033
#define MASK_ADDROL16 0xfe00707f

#endif
#ifdef DECLARE_INSN

//chaskey
DECLARE_INSN(add_rol5_xor, MATCH_CHASKEY5, MASK_CHASKEY5)
DECLARE_INSN(add_rol8_xor, MATCH_CHASKEY8, MASK_CHASKEY8)
DECLARE_INSN(add_rol7_xor, MATCH_CHASKEY7, MASK_CHASKEY7)
DECLARE_INSN(add_rol13_xor, MATCH_CHASKEY13, MASK_CHASKEY13)
DECLARE_INSN(add_rol16, MATCH_ADDROL16, MASK_ADDROL16)

//chacha20
DECLARE_INSN(xor_rol16, MATCH_XORROL16, MASK_XORROL16)
DECLARE_INSN(xor_rol12, MATCH_XORROL12, MASK_XORROL12)
DECLARE_INSN(xor_rol8, MATCH_XORROL8, MASK_XORROL8)
DECLARE_INSN(xor_rol7, MATCH_XORROL7, MASK_XORROL7)

// rol.xor
DECLARE_INSN(rol16_xor, MATCH_ROL16XOR, MASK_ROL16XOR)
DECLARE_INSN(rol13_xor, MATCH_ROL13XOR, MASK_ROL13XOR)
DECLARE_INSN(rol12_xor, MATCH_ROL12XOR, MASK_ROL12XOR)
DECLARE_INSN(rol8_xor, MATCH_ROL8XOR, MASK_ROL8XOR)
DECLARE_INSN(rol7_xor, MATCH_ROL7XOR, MASK_ROL7XOR)
DECLARE_INSN(rol5_xor, MATCH_ROL5XOR, MASK_ROL5XOR)
DECLARE_INSN(rol3_xor, MATCH_ROL3XOR, MASK_ROL3XOR)

// custom0 (roli)
DECLARE_INSN(roli, MATCH_ROLI, MASK_ROLI)

// speck
DECLARE_INSN(ror8_add, MATCH_ROR8ADD, MASK_ROR8ADD)
