...
#define DISASM_RINSN_AND_ROUND(code) \
  ...
  /* custom instructions */
  DEFINE_RTYPE(add_rol5_xor);
  DEFINE_RTYPE(add_rol8_xor);
  DEFINE_RTYPE(add_rol7_xor);
  DEFINE_RTYPE(add_rol13_xor);
  DEFINE_RTYPE(add_rol16);
  DEFINE_RTYPE(xor_rol16);
  DEFINE_RTYPE(xor_rol12);
  DEFINE_RTYPE(xor_rol8);
  DEFINE_RTYPE(xor_rol7);
  DEFINE_RTYPE(rol16_xor);
  DEFINE_RTYPE(rol13_xor);
  DEFINE_RTYPE(rol12_xor);
  DEFINE_RTYPE(rol8_xor);
  DEFINE_RTYPE(rol7_xor);
  DEFINE_RTYPE(rol5_xor);
  DEFINE_RTYPE(rol3_xor);
  DEFINE_ITYPE(roli);
  DEFINE_RTYPE(ror8_add);
